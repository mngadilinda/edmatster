  ...
  const footerLinks = [
    {
      title: 'Learning',
      links: [
        { name: 'Mathematics', to: '/learn/math' },
        { name: 'Physics', to: '/learn/physics' },
        { name: 'Chemistry', to: '/learn/chemistry' },
        { name: 'Accounting', to: '/learn/accounting' },
      ],
    },
    // {
    //   title: 'Company',
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center">
            ...
            <p className="ml-4 text-base text-gray-400">
              &copy; {new Date().getFullYear()} Ed-Master. All rights reserved.
            </p>
          </div>

          <div className="mt-4 md:mt-0 flex space-x-6">
            <a
              href="https://www.facebook.com/linda.mngadi.5/"
            ...
            <a
              href="https://twitter.com/LindaMngadi4/"
              className="text-gray-400 hover:text-white"
            >
            ...
            <a
              href="https://www.instagram.com/mngadi.linda/"
              className="text-gray-400 hover:text-white"
            >
